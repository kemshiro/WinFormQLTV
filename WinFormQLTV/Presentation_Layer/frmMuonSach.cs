...
namespace WinFormQLTV.Presentation_Layer
{
    public partial class frmMuonSach : Form
    {
        ...
        private string maDauSach, tieuDe;
        ...
        {
            string sqlCommand = @"select maThongTin, isbnMa, tieuDe, ngayMuon, ngayHetHan from ThongTinMuon where ngayTra = ngayMuon ";
            kn.Open();
            ...
            dgvSachMuon.Columns[2].HeaderText = "Tiêu Đề";
            dgvSachMuon.Columns[2].Width = 200;
            dgvSachMuon.Columns[3].HeaderText = "Ngày Mượn";
            dgvSachMuon.Columns[3].Width = 200;
            dgvSachMuon.Columns[4].HeaderText = "Ngày Hết Hạn";
